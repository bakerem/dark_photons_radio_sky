...
output_dir = "/home/bakerem/dark_photon_21cm_constraints/halo_data/correct_Cls"
...
dNgdz_dat = np.genfromtxt(
    "/home/bakerem/dark_photon_21cm_constraints/halo_data/unwise_stuff/galaxy_dNg_dz.csv",
    delimiter=",",
).T
