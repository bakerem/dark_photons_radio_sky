...
def m_gamma(ne):
     ...
     # this should be equal to mA
    #  return np.sqrt(4*np.pi * phys.alpha * ne * 7.67e-15 / phys.me)
    return np.sqrt(4 * np.pi * alpha * ne * 7.67e-15 / me) #from arXiV: 2206.13520
